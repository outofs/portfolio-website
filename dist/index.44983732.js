...
if (navToggle) navToggle.addEventListener("click", showOrCloseMenu);
if (navClose) navClose.addEventListener("click", showOrCloseMenu);
/// Remove menu mobile
const navLink = document.querySelectorAll(".nav__link");
function linkAction() {
    const navMenu1 = document.querySelector(".nav__menu");
